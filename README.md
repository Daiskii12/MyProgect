...
- **Многопоточный обход** сайтов с использованием Fork-Join Pool
- **Морфологический анализ** русского языка (лемматизация слов)
- **Полнотекстовый поиск** с ранжированием по релевантности
- **Веб-интерфейс** для управления и поиска
- **REST API** для интеграции с другими системами
- **Поддержка MySQL** для хранения индекса
